    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <div class="card-body text-nowrap">
                ...
                <h4 class=" mb-0">Number of User : {{$users->count()}}</h4>

                <a href="{{route('dashboard.admin.index')}}" class="btn btn-sm btn-primary">View Profile</a>
            </div>
            <img
                    ...
                    <div class="col-md-3 col-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">{{$users->count()}}0</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">${{$rentals->count()}}0K</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">{{$testimonials->count()}}0</h5>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--    </div>--}}
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap mb-1 align-items-center">
                            <h4 class="mb-0 me-2">{{$users->count()}}0</h4>
            ...
            <div class="col-sm-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap mb-1 align-items-center">
                            <h4 class="mb-0 me-2">{{$testimonials->count()}}0</h4>
    ...
    <div class="col-xl-4 col-md-6">
        <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title m-0 me-2">Cars Brands</h5>
...
{{--                            <div class="avatar-initial bg-label-success rounded-circle">US</div>--}}
                            ...
                            <img src="{{ asset('uploads/brands/' . $brand->logo) }}" alt="Logo" >
                        </div>
                        <div>
                            <div class="d-flex align-items-center gap-1 mb-1">

                                <h6 class="mb-0">{{$brand->cars->count()}}0</h6>
