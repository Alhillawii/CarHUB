...
<head>
    ...
    <meta name="keywords"
          content="Car rentals, Affordable car rentals, Rent a car, Luxury car rental, Economy car rentals, Car hire, Vehicle rental, Long-term car rentals, SUV rentals, Airport car rentals, Cheap car rentals, Car booking">
    <meta name="description"
          content="CarHub - Affordable car rental services offering luxury, economy, and SUV rentals with flexible plans and great deals.">
...
<div class="container">
    <div class="row">
                ...
                <div class="carousel-inner">
                    @foreach($car->images as $image)
                        <div class="carousel-item active">
                            <img src="{{asset($image->path)}}" alt="Car Image" class="img-fluid w-100 d-block "
                                 style="height: 400px; object-fit: cover;">
                        </div>
                    @endforeach

                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#carImageSlider"
                        data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carImageSlider"
                        data-bs-slide="next">
        ...
        <div class="comments-section">
            ...
            <form id="commentForm" action="{{ route('car.addComment', $car->id) }}" method="POST"
                  class="comment-form">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="commentText" name="review" rows="2"
